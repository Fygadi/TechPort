...
public class DeskInstanceModel
{
    #region Constants
    /// <summary>
    ...
    private DeskInstanceModel(BluetoothLEDevice bluetoothLEDevice)
    {
    ...
    public static async Task<DeskInstanceModel> CreateAsync(string deviceId)
    {
        ...
        var bLEDeskControl = new DeskInstanceModel(device);
