...
public class DeskCommand
{
    ...
    public short GetSpeed(uint data) => GetHeightAndSpeed(data).Item1;
    public uint GetHeight(uint data) => GetHeightAndSpeed(data).Item2;
    public static (short, uint) GetHeightAndSpeed(uint data)
    {
        var speed = (short)(data >> 16);
        var height = data & 0xFFFF;
